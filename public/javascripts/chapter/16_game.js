...
function showtime() {
    var elt = document.getElementById("timeConsuming");  
    // console.log(elt);
...
function delay(){//放置堆栈爆掉就这么写了
  showhp(levelglobal);
  setTimeout(delay, 1000);
}

window.onload = function(){ // 当onload事件发生时开始显示时间和实时更新血量
  showtime();
  delay();
}
...
var Vec = class Vec {
  ...
  times(factor) {//速度矢量乘以时间间隔获得在此期间的行进距离
...
var Coin = class Coin {
  ...
  static create(pos) {
    ...
    return new Coin(basePos, basePos,
                    Math.random() * Math.PI * 2);//为了避免所有硬币都同步上下移动的情况，起始阶段随机
  }
}
...
var levelChars = {
  ".": "empty", "#": "wall", "+": "lava",//空 墙 不动的岩浆
  "@": Player, "o": Coin,//玩家 金币
  "=": Lava, "|": Lava, "v": Lava//左右 上下 上下(重置)
  // "M": Monster
};
...
DOMDisplay.prototype.syncState = function(state) {//syncState用于使显示器展开给定的状态，删除旧演员图形，重绘新演员图形
...
DOMDisplay.prototype.scrollPlayerIntoView = function(state) {//确保如果关卡延伸到视口外会滚动此视口以确保玩家位于中心位置
...
async function runGame(plans, Display) {
  for (let level = 0; level < plans.length;) {
        ...
        $.ajax({
          ...
          success: function (result) {
              ...
              for(let i=0; i<model4.length; i++){
                if(i>7) break;
                if(i%2==0){
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[1].innerHTML=model4[i].GameUser.username ;
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[2].innerHTML=model4[i].sum_score;
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[3].innerHTML=format_time(model4[i].sum_time);
                }else{
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[5].innerHTML=model4[i].GameUser.username;
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[6].innerHTML=model4[i].sum_score;
                  rank.children[3].children[0].children[Math.floor(i/2)+1].children[7].innerHTML=format_time(model4[i].sum_time);
                }
              }
          },
          error: function() {
    ...
    // 点击复制地图按钮复制当前地图
    var clipboard = new ClipboardJS('#btn_copyMap');
    ...
    myrank.onclick = function(){  
      let username = document.getElementById("islogin").innerHTML.trim().substring(3);
        ...
        $.ajax({
          ...
          success: function (result) {
              ...
              for(let i=0; i<model2.length; i++){
                ...
                if(i==0){
                    rankbox.children[0].children[0].children[1].children[0].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[1].children[1].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[1].children[2].innerHTML=model2[i].time;
                }else if(i==1){
                    rankbox.children[0].children[0].children[1].children[3].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[1].children[4].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[1].children[5].innerHTML=model2[i].time;
                }else if(i==2){
                    rankbox.children[0].children[0].children[2].children[0].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[2].children[1].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[2].children[2].innerHTML=model2[i].time;
                }else if(i==3){
                    rankbox.children[0].children[0].children[2].children[3].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[2].children[4].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[2].children[5].innerHTML=model2[i].time;
                }else if(i==4){
                    rankbox.children[0].children[0].children[3].children[0].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[3].children[1].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[3].children[2].innerHTML=model2[i].time;
                }else if(i==5){
                    rankbox.children[0].children[0].children[3].children[3].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[3].children[4].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[3].children[5].innerHTML=model2[i].time;
                }else if(i==6){
                    rankbox.children[0].children[0].children[4].children[0].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[4].children[1].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[4].children[2].innerHTML=model2[i].time;
                }else if(i==7){
                    rankbox.children[0].children[0].children[4].children[3].innerHTML=model2[i].level;
                    rankbox.children[0].children[0].children[4].children[4].innerHTML=model2[i].score;
                    rankbox.children[0].children[0].children[4].children[5].innerHTML=model2[i].time;
                }                
          }},
          error: function() {
              alert("提交失败");
    ...
    if (status == "won"){
      ...
      let usernamedata = document.getElementById("islogin").innerHTML.trim().substring(3);
      ...
      if(!isUserDesignedMap){ // 若当前地图是用户自定义地图闯关数据不录入数据库中
        $.ajax({
          type: "POST",                  
          dataType: "json",              
